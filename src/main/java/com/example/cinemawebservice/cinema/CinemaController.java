...
public class CinemaController {
    ...
    public ResponseEntity<?> post_cinema(@RequestBody Map<String, Cinema> map) {
        return ResponseEntity.ok().body(cinemaService.add_new_cinema(map.get("cinema").getName(), map.get("cinema").getAddress(), map.get("cinema").getFilm(), map.get("cinema").getSeance()));
    }
